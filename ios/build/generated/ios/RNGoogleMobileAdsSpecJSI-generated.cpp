...
static jsi::Value __hostFunction_NativeAppModuleCxxSpecJSI_initializeApp(jsi::Runtime &rt, TurboModule &turboModule, const jsi::Value* args, size_t count) {
  return static_cast<NativeAppModuleCxxSpecJSI *>(&turboModule)->initializeApp(
    rt,
    count <= 0 ? throw jsi::JSError(rt, "Expected argument in position 0 to be passed") : args[0].asObject(rt),
    count <= 1 ? throw jsi::JSError(rt, "Expected argument in position 1 to be passed") : args[1].asObject(rt)
  );
}
static jsi::Value __hostFunction_NativeAppModuleCxxSpecJSI_setAutomaticDataCollectionEnabled(jsi::Runtime &rt, TurboModule &turboModule, const jsi::Value* args, size_t count) {
  static_cast<NativeAppModuleCxxSpecJSI *>(&turboModule)->setAutomaticDataCollectionEnabled(
    rt,
...
static jsi::Value __hostFunction_NativeAppModuleCxxSpecJSI_deleteApp(jsi::Runtime &rt, TurboModule &turboModule, const jsi::Value* args, size_t count) {
  return static_cast<NativeAppModuleCxxSpecJSI *>(&turboModule)->deleteApp(
    rt,
    count <= 0 ? throw jsi::JSError(rt, "Expected argument in position 0 to be passed") : args[0].asString(rt)
  );
}
static jsi::Value __hostFunction_NativeAppModuleCxxSpecJSI_eventsNotifyReady(jsi::Runtime &rt, TurboModule &turboModule, const jsi::Value* args, size_t count) {
  static_cast<NativeAppModuleCxxSpecJSI *>(&turboModule)->eventsNotifyReady(
    rt,
    count <= 0 ? throw jsi::JSError(rt, "Expected argument in position 0 to be passed") : args[0].asBool()
  );
  return jsi::Value::undefined();
}
static jsi::Value __hostFunction_NativeAppModuleCxxSpecJSI_eventsGetListeners(jsi::Runtime &rt, TurboModule &turboModule, const jsi::Value* args, size_t count) {
  return static_cast<NativeAppModuleCxxSpecJSI *>(&turboModule)->eventsGetListeners(
    rt
  );
}
static jsi::Value __hostFunction_NativeAppModuleCxxSpecJSI_eventsPing(jsi::Runtime &rt, TurboModule &turboModule, const jsi::Value* args, size_t count) {
  return static_cast<NativeAppModuleCxxSpecJSI *>(&turboModule)->eventsPing(
    rt,
    count <= 0 ? throw jsi::JSError(rt, "Expected argument in position 0 to be passed") : args[0].asString(rt),
    count <= 1 ? throw jsi::JSError(rt, "Expected argument in position 1 to be passed") : args[1].asObject(rt)
  );
}
static jsi::Value __hostFunction_NativeAppModuleCxxSpecJSI_eventsAddListener(jsi::Runtime &rt, TurboModule &turboModule, const jsi::Value* args, size_t count) {
  static_cast<NativeAppModuleCxxSpecJSI *>(&turboModule)->eventsAddListener(
    rt,
    count <= 0 ? throw jsi::JSError(rt, "Expected argument in position 0 to be passed") : args[0].asString(rt)
  );
  return jsi::Value::undefined();
}
static jsi::Value __hostFunction_NativeAppModuleCxxSpecJSI_eventsRemoveListener(jsi::Runtime &rt, TurboModule &turboModule, const jsi::Value* args, size_t count) {
  static_cast<NativeAppModuleCxxSpecJSI *>(&turboModule)->eventsRemoveListener(
    rt,
    count <= 0 ? throw jsi::JSError(rt, "Expected argument in position 0 to be passed") : args[0].asString(rt),
    count <= 1 ? throw jsi::JSError(rt, "Expected argument in position 1 to be passed") : args[1].asBool()
  );
...
static jsi::Value __hostFunction_NativeAppModuleCxxSpecJSI_addListener(jsi::Runtime &rt, TurboModule &turboModule, const jsi::Value* args, size_t count) {
  static_cast<NativeAppModuleCxxSpecJSI *>(&turboModule)->addListener(
    rt,
    count <= 0 ? throw jsi::JSError(rt, "Expected argument in position 0 to be passed") : args[0].asString(rt)
  );
  return jsi::Value::undefined();
}
static jsi::Value __hostFunction_NativeAppModuleCxxSpecJSI_removeListeners(jsi::Runtime &rt, TurboModule &turboModule, const jsi::Value* args, size_t count) {
  static_cast<NativeAppModuleCxxSpecJSI *>(&turboModule)->removeListeners(
    rt,
    count <= 0 ? throw jsi::JSError(rt, "Expected argument in position 0 to be passed") : args[0].asNumber()
  );
  return jsi::Value::undefined();
}
static jsi::Value __hostFunction_NativeAppModuleCxxSpecJSI_metaGetAll(jsi::Runtime &rt, TurboModule &turboModule, const jsi::Value* args, size_t count) {
  return static_cast<NativeAppModuleCxxSpecJSI *>(&turboModule)->metaGetAll(
    rt
  );
}
static jsi::Value __hostFunction_NativeAppModuleCxxSpecJSI_jsonGetAll(jsi::Runtime &rt, TurboModule &turboModule, const jsi::Value* args, size_t count) {
  return static_cast<NativeAppModuleCxxSpecJSI *>(&turboModule)->jsonGetAll(
    rt
  );
}
static jsi::Value __hostFunction_NativeAppModuleCxxSpecJSI_preferencesSetBool(jsi::Runtime &rt, TurboModule &turboModule, const jsi::Value* args, size_t count) {
  return static_cast<NativeAppModuleCxxSpecJSI *>(&turboModule)->preferencesSetBool(
    rt,
    count <= 0 ? throw jsi::JSError(rt, "Expected argument in position 0 to be passed") : args[0].asString(rt),
    count <= 1 ? throw jsi::JSError(rt, "Expected argument in position 1 to be passed") : args[1].asBool()
  );
}
static jsi::Value __hostFunction_NativeAppModuleCxxSpecJSI_preferencesSetString(jsi::Runtime &rt, TurboModule &turboModule, const jsi::Value* args, size_t count) {
  return static_cast<NativeAppModuleCxxSpecJSI *>(&turboModule)->preferencesSetString(
    rt,
    count <= 0 ? throw jsi::JSError(rt, "Expected argument in position 0 to be passed") : args[0].asString(rt),
    count <= 1 ? throw jsi::JSError(rt, "Expected argument in position 1 to be passed") : args[1].asString(rt)
  );
}
static jsi::Value __hostFunction_NativeAppModuleCxxSpecJSI_preferencesGetAll(jsi::Runtime &rt, TurboModule &turboModule, const jsi::Value* args, size_t count) {
  return static_cast<NativeAppModuleCxxSpecJSI *>(&turboModule)->preferencesGetAll(
    rt
  );
}
static jsi::Value __hostFunction_NativeAppModuleCxxSpecJSI_preferencesClearAll(jsi::Runtime &rt, TurboModule &turboModule, const jsi::Value* args, size_t count) {
  return static_cast<NativeAppModuleCxxSpecJSI *>(&turboModule)->preferencesClearAll(
    rt
  );
}

NativeAppModuleCxxSpecJSI::NativeAppModuleCxxSpecJSI(std::shared_ptr<CallInvoker> jsInvoker)
  : TurboModule("RNAppModule", jsInvoker) {
  methodMap_["initializeApp"] = MethodMetadata {2, __hostFunction_NativeAppModuleCxxSpecJSI_initializeApp};
  methodMap_["setAutomaticDataCollectionEnabled"] = MethodMetadata {2, __hostFunction_NativeAppModuleCxxSpecJSI_setAutomaticDataCollectionEnabled};
  methodMap_["deleteApp"] = MethodMetadata {1, __hostFunction_NativeAppModuleCxxSpecJSI_deleteApp};
  methodMap_["eventsNotifyReady"] = MethodMetadata {1, __hostFunction_NativeAppModuleCxxSpecJSI_eventsNotifyReady};
  methodMap_["eventsGetListeners"] = MethodMetadata {0, __hostFunction_NativeAppModuleCxxSpecJSI_eventsGetListeners};
  methodMap_["eventsPing"] = MethodMetadata {2, __hostFunction_NativeAppModuleCxxSpecJSI_eventsPing};
  methodMap_["eventsAddListener"] = MethodMetadata {1, __hostFunction_NativeAppModuleCxxSpecJSI_eventsAddListener};
  methodMap_["eventsRemoveListener"] = MethodMetadata {2, __hostFunction_NativeAppModuleCxxSpecJSI_eventsRemoveListener};
  methodMap_["addListener"] = MethodMetadata {1, __hostFunction_NativeAppModuleCxxSpecJSI_addListener};
  methodMap_["removeListeners"] = MethodMetadata {1, __hostFunction_NativeAppModuleCxxSpecJSI_removeListeners};
  methodMap_["metaGetAll"] = MethodMetadata {0, __hostFunction_NativeAppModuleCxxSpecJSI_metaGetAll};
  methodMap_["jsonGetAll"] = MethodMetadata {0, __hostFunction_NativeAppModuleCxxSpecJSI_jsonGetAll};
  methodMap_["preferencesSetBool"] = MethodMetadata {2, __hostFunction_NativeAppModuleCxxSpecJSI_preferencesSetBool};
  methodMap_["preferencesSetString"] = MethodMetadata {2, __hostFunction_NativeAppModuleCxxSpecJSI_preferencesSetString};
  methodMap_["preferencesGetAll"] = MethodMetadata {0, __hostFunction_NativeAppModuleCxxSpecJSI_preferencesGetAll};
  methodMap_["preferencesClearAll"] = MethodMetadata {0, __hostFunction_NativeAppModuleCxxSpecJSI_preferencesClearAll};
}
