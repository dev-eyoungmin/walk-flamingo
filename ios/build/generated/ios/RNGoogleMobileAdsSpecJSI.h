...
namespace facebook::react {
  ...
  class JSI_EXPORT NativeAppModuleCxxSpecJSI : public TurboModule {
protected:
  NativeAppModuleCxxSpecJSI(std::shared_ptr<CallInvoker> jsInvoker);
...
protected:
  NativeAppModuleCxxSpec(std::shared_ptr<CallInvoker> jsInvoker)
    : TurboModule(std::string{NativeAppModuleCxxSpec::kModuleName}, jsInvoker),
      delegate_(reinterpret_cast<T*>(this), jsInvoker) {}


private:
  class Delegate : public NativeAppModuleCxxSpecJSI {
  public:
    Delegate(T *instance, std::shared_ptr<CallInvoker> jsInvoker) :
      NativeAppModuleCxxSpecJSI(std::move(jsInvoker)), instance_(instance) {
  ...
  private:
    friend class NativeAppModuleCxxSpec;
    T *instance_;
  };
